...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('tiny-emitter/instance'), require('vue')) :
  typeof define === 'function' && define.amd ? define(['exports', 'tiny-emitter/instance', 'vue'], factory) :
  (global = global || self, factory(global.Hooper = {}, global.emitter, global.Vue));
}(this, function (exports, emitter, vue) { 'use strict';
  ...
  function normalizeChildren(context) {
    ...
    return context.$slots.default(slotProps)[0].children || [];
  }
  ...
  var Carousel = {
    ...
    render: function render() {
      ...
      var body = renderBody.call(this, vue.h);
  ...
  function renderSlides() {
    ...
    for (var i = 0; i < childrenCount; i++) {
      ...
      child.key = idx;
      child.props = _objectSpread({}, child.props || {}, {
        isClone: false,
        index: idx++
      });
      slides.push(child);
    ...
    return vue.h('ul', {
      ...
      onMousedown: this.config.mouseDrag ? function (e) {
        self.onDragStart(e);
      } : undefined,
      onTouchstart: this.config.mouseDrag ? function (e) {
        self.onDragStart(e);
      } : undefined
    }, slides);
  }
  ...
  function renderBody() {
    var slides = renderSlides.call(this, vue.h);
    var addonsFn = this.$slots['hooper-addons'];
    var addons = Boolean(addonsFn) ? addonsFn() : [];
    var a11y = vue.h('div', {
  ...
  function renderDefault(current, totalCount, slideToIndex) {
    ...
    var _loop = function _loop(i) {
      children.push(renderIndicator(i, i === current, function () {
  ...
  var Pagination = {
    ...
    render: function render() {
      ...
      var children = this.mode === 'indicator' ? renderDefault(this.currentSlide, totalCount, function (index) {
  ...
  function renderButton(disabled, slot, isPrev, _ref, onClick) {
    var _class;

    var isVertical = _ref.isVertical,
        isRTL = _ref.isRTL;
    var children = Boolean(slot) ? slot() : [vue.h(Icon, {
      props: {
  ...
  var Navigation = {
    ...
    render: function render() {
      ...
      var children = [renderButton(this.isPrevDisabled, this.$slots['hooper-prev'], true, config, function () {
        return _this.slidePrev();
      }), renderButton(this.isNextDisabled, this.$slots['hooper-next'], false, config, function () {
